...
description: >-
  Recover prior attempts safely by searching repo artifacts first and only then using a bounded
  recent-session fallback when the harness exposes searchable history
