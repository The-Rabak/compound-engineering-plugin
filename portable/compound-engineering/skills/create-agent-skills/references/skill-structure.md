...
| `model` | Explicit model IDs such as `claude-sonnet-5`, with platform-specific overrides like `platforms.copilot.model: gpt-5.3-codex` when needed |
...
| Descriptive | `git-worktree`, `frontend-design`, `laravel-conventions` |
