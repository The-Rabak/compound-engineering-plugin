...
| `model` | No | Model to use. Prefer explicit IDs such as `claude-sonnet-5`, and use platform-specific overrides like `platforms.copilot.model: gpt-5.3-codex` when GPT routing should differ. |
