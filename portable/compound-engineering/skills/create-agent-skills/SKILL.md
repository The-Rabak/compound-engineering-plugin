...
description: >-
  Expert guidance for creating Claude Code skills and slash commands. Use when working with SKILL.md
  files, authoring new skills, improving existing skills, creating slash commands, or understanding
...
| `model` | No | Model to use. Prefer explicit IDs. In this repo, default reasoning work to `claude-sonnet-5`, GPT code/review work to `gpt-5.3-codex` via platform overrides, and reserve `claude-haiku-4-5-20251001` / `gpt-5.4-mini` for lightweight search or research tasks. |
