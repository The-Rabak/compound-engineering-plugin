...
description: >-
  Package one plan execution packet into a compact ticket-local execution packet with parent refs,
...
Before packaging a ticket, load `commands/workflows/references/ticket-execution-contract.md` (or the platform-local equivalent), quote its first non-empty line, and use it as the output contract.
