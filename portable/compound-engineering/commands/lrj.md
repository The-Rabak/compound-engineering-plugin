---
name: lrj
description: Full autonomous engineering workflow from an existing plan through ticketization, ticket audit, two-batch work/review/triage loops, and validation
