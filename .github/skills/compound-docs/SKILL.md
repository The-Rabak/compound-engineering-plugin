...
- Foundational requirement (Laravel, API services, threading, etc.)
...
Action:
1. Prompt: "Which skill? (compound-docs, etc.)"
...
Example: For a Vue component styling variants solution:
- Add to `compound-docs/references/resources.md` under "Project-Specific Resources"
- Add to `compound-docs/references/examples.md` with link to solution doc
...
2. Run `python3 .github/skills/skill-creator/scripts/init_skill.py [skill-name]`
