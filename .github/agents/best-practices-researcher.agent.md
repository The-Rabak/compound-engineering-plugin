...
user: "We're adding JWT authentication to our Laravel API. What are the current best practices?"
assistant: "Let me use the best-practices-researcher agent to research current JWT authentication best practices, security considerations, and Laravel-specific implementation patterns."
...
1. **Discover Available Skills**:
   - Use Glob to find all SKILL.md files: `**/**/skill.md` and `~/.copilot/skills/**/skill.md`
   - Also check project-level skills: `.github/skills/**/skill.md`
...
2. **Organize Discoveries**:
   ...
   - Clearly indicate source: "From skill: laravel-conventions" vs "From official docs" vs "Community consensus"
...
- **Skill-based**: "The laravel-conventions skill recommends..." (highest authority - curated)
