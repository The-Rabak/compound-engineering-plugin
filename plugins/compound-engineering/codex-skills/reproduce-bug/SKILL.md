...
## Arguments
[issue number, issue URL, failing command, or bug description]
...
- **Open uncertainty:** ...
- **Recommended next step:** `$workflows-debug skill` | `systematic-debugging` | direct fix | ask for missing setup
```
