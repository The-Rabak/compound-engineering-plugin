...
5. If the source packet is too vague to produce a compact ticket without guessing, stop and send the workflow back to `$deepen-plan skill`.
...
- gives `$workflows-work skill` enough local context to execute one ticket safely
