...
```bash
# Get plugin version
cat ~/.codex/plugins/installed_plugins.json 2>/dev/null | grep -A5 "compound-engineering" | head -10 || echo "Plugin info not found"
...
---
*Reported via `$report-bug skill` command*
```
