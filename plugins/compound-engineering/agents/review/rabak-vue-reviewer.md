...
**P1 - Critical** (MUST fix -- bugs, security issues, accessibility failures, broken reactivity)
**P2 - Important** (SHOULD fix -- anti-patterns, performance issues, maintainability concerns)
**P3 - Suggestion** (CONSIDER fixing -- style improvements, minor optimizations, alternative approaches)
...
- **Severity** -- P1 (critical), P2 (important), or P3 (suggestion)
