...
description: "Performs the lightweight per-unit code quality check inside `/workflows:work` inline review mode after spec compliance passes. Use only with the filled quality-review prompt template."
