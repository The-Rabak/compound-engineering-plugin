...
- **Workflow model routing** -- `/lrj`, `/workflows:to-issues`, `/workflows:work`, `/workflows:review`, and `/workflows:triage` now declare `claude-opus-4-8` for Claude/non-Codex surfaces while preserving `gpt-5.5` for Codex exports.
