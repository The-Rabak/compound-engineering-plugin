...
```markdown
---
review_agents: [rabak-laravel-reviewer, code-simplicity-reviewer, security-sentinel]
plan_review_agents: [rabak-laravel-reviewer, code-simplicity-reviewer]
---
...
|------|--------------|-------------------|
| Rails | rabak-laravel-reviewer, code-simplicity-reviewer, security-sentinel, performance-oracle | rabak-laravel-reviewer, code-simplicity-reviewer |
| Python | rabak-python-reviewer, code-simplicity-reviewer, security-sentinel, performance-oracle | rabak-python-reviewer, code-simplicity-reviewer |
| TypeScript | rabak-typescript-reviewer, code-simplicity-reviewer, security-sentinel, performance-oracle | rabak-typescript-reviewer, code-simplicity-reviewer |
...
- Rails: rabak-laravel-reviewer, code-simplicity-reviewer, security-sentinel, performance-oracle
...
`commands/technical_review.md` is a one-line command (`Have @agent-rabak-laravel-reviewer @agent-code-simplicity-reviewer review...`) with `disable-model-invocation: true`. It duplicates the `/plan_review` skill. Delete it.
