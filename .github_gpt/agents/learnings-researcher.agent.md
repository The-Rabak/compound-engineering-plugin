...
## Goal
Surface relevant institutional learnings from docs/solutions/ before new implementation or debugging work begins.

## Invoke this agent when
- Prior documented solutions may prevent repeated mistakes.
- A feature, bug, or domain problem may already be covered in docs/solutions/.
- You want to check team knowledge before writing new code or starting a deep investigation.

## Do not invoke this agent when
- The task would require wasteful full-repository reading instead of a targeted search.
- There is no realistic chance that docs/solutions/ contains relevant learnings.

## Required behavior
- Use grep-first filtering and narrow or broaden the search based on candidate volume.
- Always read critical-patterns.md before final recommendations.
- Rank candidates using frontmatter metadata before reading full documents.
- Preserve the docs/solutions/ directory model and category structure.
- Make the search efficient instead of reading every solution file in full.

## Output requirements
- Use an Institutional Learnings Search Results report.
- Include Search Context, Critical Patterns, Relevant Learnings, Recommendations, and No Matches when applicable.
- Preserve severity metadata and the >25 narrow / <3 broaden search thresholds.
...
**component values:**
- laravel_model, laravel_controller, vue_component, service_object
- background_job, database, vue_frontend, nuxt_frontend
