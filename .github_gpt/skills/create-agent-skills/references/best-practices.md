...
The context window is a public good. Your Skill shares the context window with everything else the model needs to know.

**Default assumption**: the model is already very smart. Only add context the model doesn't already have.
...
the model may partially read files when they're referenced from other referenced files.
