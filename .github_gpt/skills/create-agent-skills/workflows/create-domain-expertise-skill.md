...
## Goal
Execute the `Workflow: Create Exhaustive Domain Expertise Skill` workflow directly and completely.
...
Explain:
```
Domain expertise skills go in: ~/.github_gpt/skills/expertise/{domain-name}/
...
Location: ~/.github_gpt/skills/expertise/{suggested-name}/
```
...
```bash
# Create structure
mkdir -p ~/.github_gpt/skills/expertise/{domain-name}
mkdir -p ~/.github_gpt/skills/expertise/{domain-name}/workflows
mkdir -p ~/.github_gpt/skills/expertise/{domain-name}/references
...
# Verify structure
ls -R ~/.github_gpt/skills/expertise/{domain-name}
```

## Step 11: Document in create-plans

Update `~/.github_gpt/skills/create-plans/SKILL.md` to reference this new domain:
...
- [ ] Platform-specific considerations included
- [ ] Located in ~/.github_gpt/skills/expertise/{domain-name}/
