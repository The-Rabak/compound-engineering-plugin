...
## Goal
Validate the documentation site and confirm that the repository is ready for GitHub Pages deployment.

## Use this skill when
- Documentation changes need deployment-readiness verification.
- The team needs GitHub Pages setup or deployment instructions.
- The docs site should be checked before merge or release.

## Do not use this skill when
- The docs site is not the target of the current work.
- Required documentation assets are knowingly incomplete and not ready to validate.

## Non-negotiable rules
- Validate documentation before discussing deployment.
- Check component counts, JSON validity, and required HTML page presence.
- Warn about uncommitted documentation changes before declaring readiness.
- Preserve and present the GitHub Pages workflow requirements.
- Make deployment-readiness status explicit.
...
## Required output
Return a deployment-readiness report with:
- Validation results for counts, JSON, and HTML pages.
- Whether docs changes are clean or need a commit.
- Whether the Pages workflow exists or must be added.
- The exact next-step checklist for deployment.
