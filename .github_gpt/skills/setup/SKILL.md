...
## Use this skill when
- The project does not have review-agent configuration yet.
- Review or work workflows need a stack-aware agent configuration.
- The current settings should be reconfigured deliberately.

## Do not use this skill when
- Existing configuration should remain untouched and no reconfiguration is desired.
- The task is to review code, not configure the review system.

## Non-negotiable rules
- If `compound-engineering.local.md` already exists, do not overwrite it silently.
- Auto-detect the project stack from repository files.
- Ask whether to auto-configure or customize.
- If customizing, ask all five questions: stack, focus areas, depth, TDD mode, and review mode.
- Write YAML frontmatter with `review_agents`, `plan_review_agents`, `tdd_enabled`, and `review_mode`.
- Include a `# Review Context` section in the file body.
...
- Review depth.
- Agent count.
- The configured review agent list.
- The configured review mode and TDD mode.
