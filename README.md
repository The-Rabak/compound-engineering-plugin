...
The project packages a constitution-first, spec-driven workflow system for AI-assisted engineering: **38 specialized agents, 27 commands, and 28 skills** built from one portable definition set and emitted into multiple agent harnesses.
